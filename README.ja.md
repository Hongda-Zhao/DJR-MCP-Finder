...
![DJR-MCP Finder の予測フロー](docs/assets/readme/readme_workflow.svg)
...
![開発データの構成と component-safe な固定分割](docs/assets/readme/readme_development_data.svg)
...
![共通の component-safe 5-fold Train CV](docs/assets/readme/readme_shared_train_cv.svg)
...
![候補 encoder 14 種による V0 モデル選択 Benchmark](docs/assets/readme/readme_v0_model_selection.svg)
...
![Model V0 と Model V0.1 のアーキテクチャおよび凍結 component の比較](docs/assets/readme/readme_v0_v01_architecture.svg)
...
![Model V0 と Model V0.1 Candidate の Train-only 開発 Benchmark](docs/assets/readme/readme_train_cv_performance.svg)
...
![Model V0 と Model V0.1 Candidate の H1 AP および総合 S の fold 別ペア比較](docs/assets/readme/readme_v0_v01_fold_detail.svg)
...
詳細な使用方法については、[Model V0.1 Candidate](user-inference-v0.1/README.md) および [Model V0](user-inference-v0/README.md) のユーザーガイドを参照してください。データ、方法、エビデンスの適用範囲については、[科学的エビデンスの説明](docs/SCIENTIFIC_EVIDENCE.md)を参照してください。
